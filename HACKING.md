...
Here is some wisdom to help you build this project as a developer and
potential contributor.

## Developer mode

Build system targets that are only useful for developers of this project are
hidden if the `CEUnpack_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `CEUnpack_DEVELOPER_MODE` to the configure
...
Runs the executable target `CEUnpack_exe`.
